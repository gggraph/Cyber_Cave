...
*/
    ...
    public static void GiveInstantiatePermission(byte[] msg, PhotonMessageInfo info)
    {
        ...
        if (P2SHARE.GetDLByChecksum(ref chksm) == null)
        {
            ...
            {
                P2SHARE.DL dl = P2SHARE.RequestNewFile(chksm, BitConverter.ToInt32(msg, 34), msg[1],
  ...
  */
    ...
    public static void InstantiateSoundBox(byte[] msg)
    {
        ...
        if (File.Exists(soundPath))
        {
            ...
            inst.AddComponent<ComponentCreator>().Init(0);
            inst.tag = "3DMESH";
            ...
            inst.AddComponent<SoundHit>();
            inst.GetComponent<SoundHit>().SetEventFormat(_sndType);
            inst.GetComponent<SoundHit>().StartCoroutine (inst.GetComponent<SoundHit>().LoadMusic(soundPath, false) );
            return;
        }
        else
        {
            ...
            P2SHARE.DL dl = P2SHARE.RequestNewFile(chksm, BitConverter.ToInt32(msg, 98), 4,
                new NetStream.DefaultRPCMessage(msg, new PhotonMessageInfo()));
        }
    ...
    public static void InstantiateMesh(byte[] msg) // This stuff crash some time IDK WHY Probably a  bad save file server side ?
    {
        ...
        else
        {
            ...
            else
            {
                ...
                P2SHARE.DL dl = P2SHARE.RequestNewFile(chksm, BitConverter.ToInt32(msg, 98), 1, 
                    new NetStream.DefaultRPCMessage(msg, new PhotonMessageInfo()));
