...
public class VocalAuth : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // The speech recognizer intent will return the string result to onActivityResult method of Xr Rig
        pluginClass.CallStatic("setReturnObject", "XR Rig");
