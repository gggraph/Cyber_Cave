...
public class GestureStreamingMachine_old : MonoBehaviour
{
    ...
    public void StartStreamingGesture()
    {
        ...
        StartCoroutine(StreamGesture());

    }

    public IEnumerator StreamGesture() // /!\  __ We need to record offset from body for head and controllers part __ /!\
    {
        ...
        while (true)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                if (o == null) yield break;// Print an error
